...
- next_pipeline_stage: one of 'replied', 'in_progress', 'meeting_booked'
  Rules: explicit meeting agreement → meeting_booked; interested/needs_more_info/not_interested → in_progress; out_of_office or bounce → replied.
  NEVER auto-close a lead: closes (Closed Won / Closed Lost), No Show, Sent Proposal, and Call Scheduled are set by the operator, not you. Leave a not-interested reply active (in_progress) — the intent field already flags the sentiment.
