-- ============================================================
-- REVERT TO v2.3 STABLE: Restore the last known working state
-- This drops the broken v2.5 function and restores v2.3 exactly
-- ============================================================
...
-- Recreate exact v2.3 function from migration 20260117022546
...
-- Mark as v2.3 restored
COMMENT ON FUNCTION public.search_free_data_builder IS 'v2.3 STABLE RESTORED: Last known working state. All filters working.';