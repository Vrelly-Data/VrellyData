-- ============================================================
-- HARD RESET: Drop ALL overloads and recreate SINGLE canonical function
-- Based on Jan 13 2026 baseline + p_technologies added
-- ============================================================
...
-- Step 2: Create the SINGLE CANONICAL function matching useFreeDataSearch.ts exactly
-- Parameter order matches the frontend hook EXACTLY
...
-- Add comment to mark as canonical - DO NOT CREATE OVERLOADS
COMMENT ON FUNCTION public.search_free_data_builder IS 'CANONICAL Builder search function - Jan 15 2026. Matches useFreeDataSearch.ts exactly. DO NOT CREATE OVERLOADS - always drop all and recreate.';
