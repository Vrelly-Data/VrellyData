...
BEGIN
  ...
  WHERE fd.entity_type = p_entity_type
    ...
    AND (
      ...
      OR (
        -- Direct seniority field match (case-insensitive)
        LOWER(fd.entity_data->>'seniority') = ANY(SELECT LOWER(unnest(p_seniority)))
        -- C-Level matching: search for all C-suite titles
        OR (
        ...
        -- President matching: President but NOT Vice President
        OR (
        ...
        -- VP matching: Vice President patterns
        OR (
        ...
        -- Head of matching: Head of, Principal, Managing Director
        OR (
        ...
        -- Individual Contributor matching: anyone NOT matching senior levels
        OR (
          ...
          AND (
            ...
            -- Exclude President (but not Vice President)
            ...
            -- Exclude Head of / Principal / Managing Director
