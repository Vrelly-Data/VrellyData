-- ============================================================
-- REVERT TO v2.3: Restore working search_free_data_builder function
-- Fixes the broken title_matches_seniority call from v2.4
-- ============================================================

-- Step 1: DROP the broken v2.4 function
...
-- Step 2: Recreate v2.3 function with working inline logic
...
BEGIN
  ...
  WHERE fd.entity_type = p_entity_type
    ...
    -- Prospect data filters (v2.3 field names)
...
-- Add comment
COMMENT ON FUNCTION public.search_free_data_builder IS 'v2.3 RESTORED: Working inline seniority/department logic. 29 parameters.';