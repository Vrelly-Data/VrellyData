...
function buildArticleJsonLd(resource: Resource, canonical: string): string {
  const image = resource.cover_image_url || "https://www.vrelly.com/og-image.png?v=3";
  const payload: any = {
...
function updateHtmlWithSeo(
  ...
  const image = ogImage || "https://www.vrelly.com/og-image.png?v=3";
...
export default async function handler(req: any, res: any) {
  ...
  const ogImage = resource.cover_image_url || "https://www.vrelly.com/og-image.png?v=3";
