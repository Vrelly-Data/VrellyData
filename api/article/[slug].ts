...
function buildArticleJsonLd(resource: Resource, canonical: string): string {
  const image = resource.cover_image_url || "https://www.vrelly.com/og-image.png?v=6";
  const payload: any = {
...
export default async function handler(req: any, res: any) {
  ...
  const ogImage = resource.cover_image_url || "https://www.vrelly.com/og-image.png?v=6";
